...
manual_hype_words=['envious', 'fundamentall?y?', 'futurist\w*', 'happy', 'reshape\w*', 'transformed', 'diligent', 'succeed\w*', 'extinct\w*', 'disrupt\w*', 'in a world', "ever", "high", "strong", "even", "efficient", "unique", "innovative", "exactl?y?", "lastest", "immediatel?y?", "ultimatel?y?", "certainl?y?", "powerful", "extensivel?y?", "precisel?y?", "robust", "excellent", "promising","exciting", "ultimatel?y?", "surprisingl?y?", "biggest", "vast","revolution\w*", "emphasize\w?","massive", "ambitious", "greatest", "rigorous","notable", "succeede?d?", "exceptionaly?", "importantl?y?", "fundamentall?y?", "paramount", "groundbreaking", "obviously", "impactfull?y?", "specificall?y?", "outstanding", "fastest", "essentiall?y?", "strongl?y?","pivotal", "tremendousl?y?","intuitive", "intriguing","indispensabl?e?y?", "huge", "prestigious", "talented", "remarkable"]
...
WordListDict={"predictive": predictive, "imperative":imperative, "subjunctive":subjunctive, "hype":Key_hypes, "tech": tech_words, "problem": problems_and_ignorance,"human":human, "fraud": fraud, "climate":climate, "capitalism": capitalism, "replacement":replacement,"edu":edu, "anthropomorphism": anthropomorphism, "learning": learning, "privacy":privacy,"promise": promise, "discrimination": discrimination}
